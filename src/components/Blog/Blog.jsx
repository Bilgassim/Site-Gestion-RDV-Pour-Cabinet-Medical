...
const Blog = () => {
                        ...
                        <div className="card shadow text-center border-0 rounded-bottom">
                            ...
                            <div className="card-body p-0">
                                ...
                                <div className="mt-1 mb-3 text-start">
                                    <Link to={`/blog/${item?.id}`}>
                                        <button className="btn btn-link border-0" style={{ color: '#1977cc' }}>Voir plus</button>
                                    </Link>
                                </div>
                            </div>
                        </div>
    ...
    return (
        <>
            <Header />
            <SubHeader title='Blog' subtitle='Vous y trouverez des articles informatifs et des conseils pour prendre soin de vos dents et de vos gencives.' />
