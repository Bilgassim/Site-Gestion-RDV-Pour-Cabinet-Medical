						...
						<div className="profile-widget">
							...
							<div className="pro-content">
								...
								<ul className="available-info">
									<li>
										<FaLocationArrow className='icon' /> Oujda, Maroc
									</li>
									<li>
										<FaClock className='icon' /> Disponible le Ven, 14 Juin
									</li>
									<li>
										<FaDollarSign className='icon' /> 100DH - 400DH
									</li>
								</ul>
								<div className="d-flex justify-content-between align-items-center">
									<Link to={`/doctors/profile/${item?.id}`} className="btn  btn-outline-info btn-sm view-profile-btn">Profil</Link>
									<Link to={`/booking/${item?.id}`} className="btn btn-sm book-btn">Reserver</Link>
								</div>
							</div>
						</div >
					</SwiperSlide>
