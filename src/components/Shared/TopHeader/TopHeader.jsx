        ...
        <div id="topbar" className="d-flex align-items-center fixed-top">
            <div className="container d-flex justify-content-between">
                <div className="contact-info d-flex align-items-center">
                    <FaEnvelope className='contact-icon'/> <a href="boulkassoum2002@gmail.com">boulkassoum2002@gmail.com</a>
                    <FaPhoneAlt className='contact-icon'/> <a href="tel:++212710911949">+212710911949</a> 
                </div>
