    ...
    return (
        <>
            <nav id="navbar" className="navbar order-last order-lg-0">
                <ul>
                    <li><NavLink to={'/'} className={({ isActive }) => isActive ? "nav-link scrollto active" : ""}>Accueil</NavLink></li>
                    <li><NavLink to={'/about'} className={({ isActive }) => isActive ? "nav-link scrollto active" : ""}>A propos</NavLink></li>
                    ...
                    {!isLoggedIn && <li><Link to={'/login'} className="nav-link scrollto">Connexion</Link></li>}
                </ul>
                {isLoggedIn &&
                    <div>
            ...
            <Drawer
                ...
                open={open}
                size={"default"}
                extra={<Button type="primary" onClick={onClose}> Fermer</Button>}
            >
                <ul className="mobile-menu-nav">
                    <li><NavLink to={'/'} className={({ isActive }) => isActive ? "nav-link scrollto active" : ""}><FaHome className="icon" />Accueil</NavLink></li>
                    <li><NavLink to={'/about'} className={({ isActive }) => isActive ? "nav-link scrollto active" : ""}><FaAddressBook className="icon" />A propos</NavLink></li>
                    ...
                    {!isLoggedIn && <li><Link to={'/login'} className="nav-link scrollto"><FaSignInAlt className="icon" />Connexion</Link></li>}
                </ul>
            </Drawer>
        </>
    )
