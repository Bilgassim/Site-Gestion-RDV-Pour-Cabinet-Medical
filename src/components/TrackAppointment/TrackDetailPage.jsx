      ...
      <div className='container track-detail rounded'>
        <div className="row">
          <div className="col-md-4">
            <div className="d-flex flex-column gap-4 justify-content-around">
              ...
              <div className=' card shadow-sm p-3 text-center shadow border-0 bg-danger text-white'>
                <div>
                  <h6 className='text-start text-uppercase text-black'>Docteur</h6>
                  <div className='d-flex gap-2'>
                    <div className='img-div'>
          ...
          <div className='col-md-8'>
            <h4 className='text-center text-capitalized'>Statut : {data?.status}</h4>
            ...
            <div className='d-flex justify-content-center mt-4'>
              <div className='text-center'>
                ...
                <div className='text-secondary text-start'><FaCalendarCheck className='me-2' />Date de rendez-vous : {moment(data?.scheduleDate).format("MMM Do YY")}</div>
                <div className='text-secondary text-start'><FaRegClock className='me-2' />Heure de rendez-vous : {data?.scheduleTime}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          <h4 className='text-center mt-4 text-uppercase'>Calendrier des rendez-vous :</h4>
